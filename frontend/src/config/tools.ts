...
export const TOOLS: ToolMetadata[] = [
  {
    ...
    seoTitle: 'Free Webhook Tester | DeveloperTools.dev',
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: 'JWT Debugger (Coming Soon) | DeveloperTools.dev',
    seoDescription:
      'JWT Debugger is coming soon to DeveloperTools.dev. Decode and inspect JWT claims, headers, and token structure quickly.',
    jsonLdDescription:
      'JWT Debugger for decoding tokens and inspecting claims and headers. Coming soon on DeveloperTools.dev.',
    pageIntro:
  ...
  },
  {
    ...
    seoTitle: 'JSON Formatter (Coming Soon) | DeveloperTools.dev',
    seoDescription:
      'JSON Formatter is coming soon to DeveloperTools.dev. Format and validate JSON payloads with a simple developer-focused UI.',
    jsonLdDescription:
      'JSON Formatter for formatting and validating JSON payloads. Coming soon on DeveloperTools.dev.',
    pageIntro:
  ...
  },
  {
    ...
    seoTitle: 'HMAC Generator (Coming Soon) | DeveloperTools.dev',
    seoDescription:
      'HMAC Generator is coming soon to DeveloperTools.dev. Generate HMAC signatures for webhook testing and API debugging.',
    jsonLdDescription:
      'HMAC Generator for creating signatures used in webhook verification and API debugging. Coming soon on DeveloperTools.dev.',
    pageIntro:
